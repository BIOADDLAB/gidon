        ...
        <main>
            ...
            <section className="bg-[#F9FAF5] pt-[100px] pb-[124px]">
                <div className="w-[930px] mx-auto  ">
                    ...
                    <div className="flex justify-center items-stretch gap-13 mt-[60px]">
                        {/* 왼쪽 영역 */}
                        ...
                        {/* 정보 영역 */}
                        <div className="flex-1 border border-green-600/40 rounded-[10px] flex flex-col justify-between">
                            {/* 주소 */}
                            <div className="p-[45px] flex-1">
                                ...
                                <p className="text-[18px] text-[#3d3e3c] font-medium leading-relaxed">
                                    경기도 성남시 중원구 성남대로 1126, 메가프라자 3층 <br />
                                    <span className="font-normal text-[16px] text-gray-500 block mt-1">
                            ...
                            {/* 전화 */}
                            <div className="p-[45px] flex-1 border-t border-green-600/40">
                                <div className="flex items-center gap-2  pb-2 mb-4">
                                    <span className="w-[33px] h-[33px] bg-green-600 rounded-full flex items-center justify-center">
                                        <img
                                ...
                                <p className="text-[24px] text-[#3d3e3c] font-bold tracking-wide">
                                    031-XXXX-XXXX
                                    {/* #ISSUE: 전화 연결 필요 */}
                                    <a
                                        href="tel: 010-1111-"
                                        className="inline-block text-[20px] font-bold py-[9px] px-[25px] rounded-[33px] mt-[13px] border border-green-600 bg-[#F4F1EA]"
                                    >
                                        전화 걸기
                                    </a>
                                </p>
            ...
            <section className="relative w-ful pt-[100px] pb-[130px]">
                <div className="w-[1140px] mx-auto">
                    ...
                    {/* 구글지도영역 */}
                    <div className="w-full h-[456px] bg-[#D9D9D9] rounded-[10px] mt-[58px]"></div>
                </div>
            </section>
            ...
            <section className="relative w-ful pt-[100px] pb-[130px]">
                <div className="w-[1140px] mx-auto">
                    ...
                    <div className="mt-[78px] flex justify-center flex-wrap gap-[20px] ">
                        {/* 1. 지하철 이용 */}
                        {/* 💡 최상위 부모에 bg-white, rounded, shadow, h-[350px]를 다 몰아주고 flex flex-col로 배치합니다 */}
                        <div className="w-[calc((100%-20px)/2)] h-[350px] bg-white rounded-[10px] overflow-hidden shadow-[3px_4px_14.6px_0px_rgba(72,72,72,0.1)] flex flex-col">
                            ...
                            {/* 본문 영역 - bg-white와 rounded를 제거하고 flex-1로 남은 공간을 꽉 채웁니다 */}
                        ...
                        <div className="w-[calc((100%-20px)/2)] h-[350px] bg-white rounded-[10px] overflow-hidden shadow-[3px_4px_14.6px_0px_rgba(72,72,72,0.1)] flex flex-col">
                            ...
                            {/* 진료 시간 카드는 항목이 많아 패딩을 살짝 여유롭게 잡았습니다 */}
                            <div className="pt-[44px] pb-[32px] px-[50px] flex-1">
