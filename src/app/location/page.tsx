...
export default function LocationPage() {
    ...
    return (
        <main>
            ...
            {/* #STYLE: py 대화면 확장/모바일 축소, w-[924px] 고정 → 반응형 max-w */}
            <section className="bg-[#F9FAF5] pt-[60px] pb-[80px] md:pt-[80px] md:pb-[100px] lg:pt-[100px] lg:pb-[124px] px-4">
                <div className="w-full max-w-[924px] 2xl:max-w-[1080px] mx-auto">
                    ...
                    <div className="flex flex-col lg:flex-row justify-center items-stretch gap-4 lg:gap-[13px] mt-[40px] md:mt-[60px]">
                        ...
                        {/* 오른쪽 정보 영역 — 고정폭 제거, flex-1로 가변 처리 */}
            ...
            {/* 지하철이용 */}
            {/* #STYLE: py 대화면 확장/모바일 축소, w-[1140px] 고정 → 반응형 max-w */}
            {/* #STYLE: 배경이 콘텐츠 max-w 컨테이너 안에 있어서 화면 전체를 못 채우던 문제 수정
                Image(fill)를 section 바로 아래(px-4보다 바깥)로 이동시켜 진짜 100vw로 채워지도록 변경 */}
            <section className="relative w-full pt-[70px] pb-[90px] md:pt-[90px] md:pb-[110px] lg:pt-[100px] lg:pb-[130px]">
                ...
                <div className="relative w-full max-w-[1140px] 2xl:max-w-[1320px] mx-auto px-4">
                    ...
                    {/* #STYLE: 모바일 1열, sm부터 2열 그리드. 카드 높이 h-[350px] 고정 → min-h로 변경(텍스트 길이 변동 대응) */}
