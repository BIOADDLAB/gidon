...
export default function AskForm() {
    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-center items-center font-medium text-green-600 mb-[24px] md:mb-[30px]">
                    ...
                    <button
                        ...
                        className="underline z-10 text-[14px] md:text-base cursor-pointer"
                    >
                        [자세히 보기]
                    </button>
                </div>
            ...
            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="개인정보취급방침">
                기드온치과(이하 ㅇㅇ)는 고객님의 개인정보를 중요시하며, 개인정보보호법을 준수하고 있습니다.{'\n\n'}
                1. 수집하는 개인정보 항목{'\n'}- 수집항목: 성함, 연락처, 문의내용{'\n\n'}
                2. 개인정보의 수집 및 이용목적{'\n'}- 온라인 상담 접수 및 service 제공을 위한 의사소통 경로 확보{'\n\n'}
                3. 개인정보의 보유 및 이용기간{'\n'}- 목적 달성 후 또는 고객의 파기 요청 시까지 보유하며, 관련 법령에
                따라 안전하게 파기됩니다.{'\n\n'}
                4. 동의를 거부할 권리{'\n'}- 이용자는 동의를 거부할 권리가 있으나, 동의 거부 시 온라인 상담 이용이
                제한될 수 있습니다. 1. 수집하는 개인정보 항목{'\n'}- 수집항목: 성함, 연락처, 문의내용{'\n\n'}
                2. 개인정보의 수집 및 이용목적{'\n'}- 온라인 상담 접수 및 service 제공을 위한 의사소통 경로 확보{'\n\n'}
                3. 개인정보의 보유 및 이용기간{'\n'}- 목적 달성 후 또는 고객의 파기 요청 시까지 보유하며, 관련 법령에
                따라 안전하게 파기됩니다.{'\n\n'}
                4. 동의를 거부할 권리{'\n'}- 이용자는 동의를 거부할 권리가 있으나, 동의 거부 시 온라인 상담 이용이
