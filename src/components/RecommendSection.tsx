            ...
            <div className="w-full max-w-[1200px]">
                ...
                <div className="flex justify-center gap-7 items-stretch mt-[58px] px-4">
                    {displayList.map((card, index) => (
                        <div
                            key={index}
                            className={`w-full max-w-[300px] ${card.bgClass} ${card.textColorClass} rounded-[10px] overflow-hidden shadow-[2px_4px_10px_0_rgba(73,73,73,0.25)] flex flex-col transition-transform duration-300`}
                        >
                            {/* 상단 영역 */}
                            <div
                                className="pt-[46px] pb-[38px] px-2 flex flex-col items-center text-center"
                                style={{
                            ...
                            >
                                <img src={card.iconSrc} className="w-[25px] block mb-5" alt="추천 치아 아이콘" />
                            ...
                            {/* 하단 영역 */}
                            <div className="pt-[38px] pb-10 px-6 text-center flex-grow flex justify-center items-center">
                                <p className="leading-[30px] text-[15px] font-medium whitespace-pre-line">
                                    {card.description}
                                </p>
                            </div>
                        </div>
