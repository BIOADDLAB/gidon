    ...
    return (
        <section className="bg-[#F4F3EB] py-[60px] md:py-[70px] 2xl:py-[90px] px-4">
            <div className="max-w-7xl 2xl:max-w-[1600px] mx-auto flex flex-col lg:flex-row gap-8 md:gap-10 lg:gap-15 items-stretch">
                ...
                <Reveal className="w-full lg:w-[50%] flex flex-col justify-center" y={24} x={0}>
                    ...
                    <ul className="py-3 md:py-5">
                        <li className="flex gap-6 md:gap-14.25 pb-3 md:pb-3.75 border-b border-[#3C3C3C] mb-3 md:mb-3.75">
                            <h3 className="font-semibold text-green-600 w-[4.75rem] md:w-24 shrink-0 text-[17px] md:text-lg">
                                오시는 길
                            </h3>
                            <p className="text-ink-900 text-[17px] md:text-[19px] lg:text-[20px] break-keep leading-relaxed">
                        ...
                        <li className="flex gap-6 md:gap-14.25 pb-3 md:pb-3.75 border-b border-[#3C3C3C] mb-3 md:mb-3.75">
                            ...
                            <p className="text-ink-900 text-[17px] md:text-[19px] lg:text-[20px]">1522-7528</p>
                        </li>
                        ...
                        <li className="flex gap-6 md:gap-14.25 pb-3 md:pb-3.75 border-b border-[#3C3C3C] mb-3 md:mb-3.75">
                            ...
                            <div>
                                <div className="flex items-start gap-4 md:gap-4.5 mb-2.5 md:mb-3.5">
                                    <div className="text-ink-900 text-[17px] md:text-[19px] lg:text-[20px] w-[72px] md:w-19.25 flex justify-between shrink-0">
                                        <span className="sr-only">월요일과 목요일</span>
                                        <span aria-hidden="true">월</span>
                                        <span aria-hidden="true">/</span>
                                        <span aria-hidden="true">목</span>
                                    </div>
                                    <span className="text-ink-900 text-[17px] md:text-[19px] lg:text-[20px]">
                                        09:00~20:00
                                        <br className="hidden max-[374px]:block" />
                                        <span className="ml-1 text-[17px] break-all md:text-[18px] font-medium">
                                            (야간진료)
                                        </span>
                                    </span>
                                </div>
                                ...
                                <div className="flex items-start gap-4 md:gap-4.5">
                                    ...
                                    <span className="text-ink-900 text-[17px] md:text-[19px] lg:text-[20px] text-[#AE4F4F]">
                                        휴진
                                    </span>
                                </div>
                            </div>
                        ...
                        <li className="flex gap-6 md:gap-14.25 pb-3 md:pb-3.75 border-b border-[#3C3C3C] mb-3 md:mb-3.75">
                            ...
                            <p className="text-ink-900 text-[17px] md:text-[19px] lg:text-[20px] break-keep">
                                건물 뒷편 기계식 카리프트 이용
                            </p>
                        </li>
                    </ul>
